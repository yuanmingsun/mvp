 ...
 *
 * 适合多个itemType的listview
 */

public abstract class MultiTypeListAdapter<T> extends BaseAdapter {
    ...
    public MultiTypeListAdapter(Context context, ListItemCallback<T> callback) {
        this(context);
        this.callback = callback;
    }

    public MultiTypeListAdapter(Context context, List<T> data) {
        this.context = context;
        this.data.clear();
